...
ModuleHeader MOD_HEADER = {
	"third/allsend",
	"1.00",
	"Adds the /allsend command which allows privileged server operators to send special messages lol.",
	"Valware",
	"unrealircd-6",
};
...
static char *allsend_help[] = {
	...
	"    /allsend all private global There will be a server restart in 30 minutes.",
	"-",
	NULL
};
